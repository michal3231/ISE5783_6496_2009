...
public class LightsTests {
	...
	public void sphereDirectional() {
		...
		scene1.lightSources.add(new DirectionalLight(sphereLightColor, new Vector(1, 1, -0.5)));
	...
	public void spherePoint() {
		scene1.geometries.add(sphere);
		scene1.lightSources.add(new PointLight(sphereLightColor, sphereLightPosition).setKl(0.001).setKq(0.0002));
	...
	public void sphereSpot() {
		scene1.geometries.add(sphere);
		scene1.lightSources.add(new SpotLight(sphereLightColor, sphereLightPosition, new Vector(1, 1, -0.5))
	...
	public void trianglesDirectional() {
		...
		scene2.lightSources.add(new DirectionalLight(trianglesLightColor, trianglesLightDirection));
	...
	public void trianglesPoint() {
		scene2.geometries.add(triangle1, triangle2);
		scene2.lightSources.add(new PointLight(trianglesLightColor, trianglesLightPosition).setKl(0.001).setKq(0.0002));
	...
	public void trianglesSpot() {
		scene2.geometries.add(triangle1, triangle2);
		scene2.lightSources.add(new SpotLight(trianglesLightColor, trianglesLightPosition, trianglesLightDirection)
				.setKl(0.001).setKq(0.0001));
