...
class GeometriesTests {
	...
	void testFindIntersections() {
		...
		Ray ray = new Ray(new Vector(0, 4, -1.8),new Point(0, -2, 4.1));
		...
		// TC03 cross only 1
		ray = new Ray( new Vector(0, -0.3, -1.8),new Point(0, 2.3, 4.1));
		assertEquals(2, geometries.findIntersections(ray).size(), "ERROR TC03");

		// TC04 cross nothing
		ray = new Ray( new Vector(0, -0.2, -0.7),new Point(-2, -2.3, 4.1));
